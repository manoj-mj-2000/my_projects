...
public class CheckInterceptor implements Interceptor {
	...
	@Override
	public void destroy() {
		System.out.println("Check Interceptor destroyed");
	}

	@Override
	public void init() {
		System.out.println("Check Interceptor Initialized");
	}
...
//		System.out.println("Prev Sec: "+prev_second+" Cur Second: "+curSecond);
		...
		System.out.println("~Check~ Interceptor URL: "+request.getRequestURL());
		System.out.println("~Check~ Interceptor Method: "+request.getMethod());
		System.out.println("~Check~ Interceptor Query: "+request.getQueryString());
		System.out.println("~Check~ Interceptor count: "+count);
		...
		if(flag){
			System.out.println("###Blocked by Interceptor: Check###");
