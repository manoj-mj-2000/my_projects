...
public class UserInterceptor implements Interceptor {
	...
	@Override
	public void destroy() {
		System.out.println("User Interceptor destroyed");
	}

	@Override
	public void init() {
		System.out.println("User Interceptor Initialized");
	}
...
//		System.out.println("Prev Sec: "+prev_second+" Cur Second: "+curSecond);
		...
		System.out.println("~User~ Interceptor URL: "+request.getRequestURL());
		System.out.println("~User~ Interceptor Method: "+request.getMethod());
		System.out.println("~User~ Interceptor Query: "+request.getQueryString());
		System.out.println("~User~ Interceptor count: "+count);
		...
		if(flag){
			System.out.println("###Blocked by Interceptor: User###");
