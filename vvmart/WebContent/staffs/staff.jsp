...
<body onload="getData()">
	...
	<div class="right">
		...
		<form id="cusForm1" autocomplete="off">
			<table>
				<tr>
					<td>Staff Id</td>
		...
		<form id="cusForm2"autocomplete="off" >
		<table>
			<tr>
				<td>Staff Id</td>
	...
	<script type="text/javascript">
		...
		function sendData() {
			...
			xhr.open(method, "http://localhost:8081/vvMart/staffs/staff?" + sendstr, true);
		...
		function sendData2() {
			...
			let sendstr = "data=" + uriencode;
			xhr.open("DELETE", "http://localhost:8081/vvMart/staffs/staff?" + sendstr, true);

			xhr.send(sendstr);
			}
			else{
				alert("Give a valid Staff Id");
			}
		}
		...
		function getData() {
			...
			xhr.open("GET", "http://localhost:8081/vvMart/staffs/staff", true);
			xhr.onreadystatechange = function() {
				if (this.readyState == 4 && this.status == 200) {
					gData = this.response;
					setData();
		...
		function createtab() {
			...
			th1.innerText = "Staff Id";
			tr.appendChild(th1);
			th2.innerText = "Staff Name";
			tr.appendChild(th2);
			th3.innerText = "Staff Mobile";
			tr.appendChild(th3);
